...
import pictureProfile from "../assets/picture-profile.png"
        ...
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center lg:items-start">
                    <h1 className='pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl'>Stephane Monnier</h1>
            ...
            <div className="w-full lg:w-1/2 lg:p-8">
                <img src={pictureProfile} alt="profile picture" className="rounded-full"/>
            </div>
        </div>
    </div>
  )
